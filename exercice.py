...
def to_degrees(angle_rads: float) -> tuple:
    ...
    deg = deg - math.floor(angle_rads/math.pi*180)
    angle_mins = deg*60
    deg = angle_mins-math.floor(angle_mins)
    angle_secs = angle_mins*3600

    return round(deg,2), round(angle_mins,2), round(angle_secs,2)
